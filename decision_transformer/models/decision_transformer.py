...
class DecisionTransformer(TrajectoryModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.embed_return = nn.Sequential(
            nn.Linear(self.return_dim * 2, hidden_size),
            # nn.ReLU(),
    ...
    def forward(
        ...
        return_masks = returns_to_go == -100
        returns_to_go[return_masks] = -10.0
        cat_returns_to_go = torch.cat([returns_to_go, return_masks], dim=-1)
        returns_embeddings = self.embed_return(cat_returns_to_go)
